...
![Early formal system block diagram](Block_diagram.png)
...
![Final schematic overview](final_schematic.png)

![Final PCB layout view](final_pcb_view.png)

![Final 3D PCB render](final_3d_pcb_render.png)
...
![HI5731 DAC pinout used during breadboard demo](demo_dac_pinout.png)

![Breadboard demo setup with ESP32 and DAC wiring](breadboard_demo.JPG)
...
![Stair-step output from the breadboard DAC](stairstep.jpg)
...
![Heart pattern generated by the breadboard DAC prototype](heart_breadboard.jpg)
...
![Programmable raw PCB before final connector assembly](programable_pcb.jpeg)
...
![Assembled PCB outputting a heart on the oscilloscope](Assembled_PCB.jpg)
...
![Zig-zag artifact near output limits](zig_zag.jpeg)
...
![Etch-a-Sketch drawing on the oscilloscope](etch_a_sketch_drawing.JPG)
...
![LDAC period around 8.4 us, corresponding to roughly 115-120 kHz update rate](8.4us_ldac.jpeg)
...
![Z-blanking schematic](Z_blank_schematic.png)

The Tektronix manual information was reviewed to understand the external Z modulation input behavior.

![Tektronix Z modulation manual reference](Z_modulation_tek_manual.png)
...
![Choppy live audio visualization on oscilloscope](choppy_live_audio_on_oscilliscope.jpg)
...
![Audio telemetry log showing packet acceptance / continuity issues](terminal_log_audio.png)
...
![Completed OscilloSketch board installed in enclosure](Completed_board_picture_in_enclosure.jpg)
...
![Final OscilloSketch block diagram](final_block_diagram.png)
